...
\usepackage{setspace}
\setstretch{1.2}                       % Zeilenabstand (DHBW: 1,2 bis 1,5-zeilig)
...
%% Zeilenumbruch: verhindert, dass lange Bindestrich-Komposita
%% (z.B. In-Context-Verarbeitung, Code-Generierungs-Modus) in den Rand ragen.
%% TeX darf die betroffenen Zeilen stattdessen etwas lockerer setzen.
\setlength{\emergencystretch}{3em}

%% Umbrueche in URLs und DOIs des Literaturverzeichnisses erlauben
