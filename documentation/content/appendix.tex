...
Sämtlicher Code, die Erzeugungsvorschrift des Datensatzes, die regelbasierte Vergleichspipeline, die Prompt-Vorlagen sowie alle Ergebnisdatensätze der 711
...
\begin{description}
    ...
    \item[\texttt{project/data/results\_*/}] Die Ergebnisdatensätze je Lauf sowie die erzeugten Skripte und Ergebnistabellen, getrennt nach Startwert des Datensatzes.
\end{description}
