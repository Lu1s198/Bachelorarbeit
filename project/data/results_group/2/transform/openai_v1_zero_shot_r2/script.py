...
output_path = r"C:/Users/geige/Desktop/DHBW/Bachelorarbeit/project/data/results_group/2/transform/openai_v1_zero_shot_r2/output.parquet"
...
products["price_eur"] = products["price_eur"].apply(parse_price).astype("Float64")
