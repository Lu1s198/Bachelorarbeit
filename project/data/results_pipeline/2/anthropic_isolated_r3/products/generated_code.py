...
output_path = "C:/Users/geige/Desktop/DHBW/Bachelorarbeit/project/data/results_pipeline/2/anthropic_isolated_r3/products/output.parquet"
...
def parse_bool(val):
    ...
    true_vals = {'ja', 'true', '1', 'yes', 'wahr', 'y', 'j'}
    false_vals = {'nein', 'false', '0', 'no', 'falsch', 'n'}
    if s in true_vals:
        return True
    if s in false_vals:
        return False
