...
output_path = r"C:/Users/geige/Desktop/DHBW/Bachelorarbeit/project/data/results_pipeline/2/openai_isolated_r2/dedup_medium/output.parquet"
...
result = df.drop_duplicates(subset=["email"], keep="first").drop(columns=["_registered_at_sort"])
