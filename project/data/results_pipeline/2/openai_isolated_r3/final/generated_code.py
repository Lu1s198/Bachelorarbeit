...
output_path = r"C:/Users/geige/Desktop/DHBW/Bachelorarbeit/project/data/results_pipeline/2/openai_isolated_r3/final/output.parquet"
...
customers = customers[
    ...
    & customers["country_code"].isin(valid_country_codes)
...
result = (
    ...
    .agg(
        total_revenue_eur=("line_revenue_eur", "sum"),
