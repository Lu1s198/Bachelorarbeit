...
output_path = r"C:/Users/geige/Desktop/DHBW/Bachelorarbeit/project/data/results_pipeline/2/openai_r3/orders/output.parquet"
...
ordered_datetime = pd.to_datetime(df["ordered_at"], errors="coerce", format="mixed")
