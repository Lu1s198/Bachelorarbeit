...
output_path = r"C:/Users/geige/Desktop/DHBW/Bachelorarbeit/project/data/results_pipeline/2/openai_r4/orders/output.parquet"

df = pd.read_csv(input_path)

df["total_eur"] = df["quantity"] * df["unit_price_eur"]

ordered_dates = pd.to_datetime(df["ordered_at"], errors="coerce")
